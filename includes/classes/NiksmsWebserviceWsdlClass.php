<?php
/**
 * File for NiksmsWebserviceWsdlClass to communicate with SOAP service
 ...
 */
/**
 * NiksmsWebserviceWsdlClass to communicate with SOAP service
 * 
 * @package NiksmsWebservice
 * @author WsdlToPhp Team <contact@wsdltophp.com>
 * @version 20150429-01
 * @date 2016-01-03
 */
class NiksmsWebserviceWsdlClass extends stdClass implements ArrayAccess,Iterator,Countable
{
    /**
     ...
     * @var string
     */
    const VALUE_WSDL_URL = 'http://niksms.com:1370/NiksmsWebservice.svc?wsdl';
    /**
    ...
    /**
     * Constructor
     * @uses NiksmsWebserviceWsdlClass::setLastError()
     * @uses NiksmsWebserviceWsdlClass::initSoapClient()
     * @uses NiksmsWebserviceWsdlClass::initInternArrayToIterate()
     * @uses NiksmsWebserviceWsdlClass::_set()
     ...
     * @return NiksmsWebserviceWsdlClass
     */
     ...
     * @return NiksmsWebserviceWsdlClass|null
     */
    public static function __set_state(array $_array,$_className = __CLASS__)
    {
        if(class_exists($_className))
        {
            ...
            if(is_object($object) && is_subclass_of($object,'NiksmsWebserviceWsdlClass'))
            {
     ...
     * @uses NiksmsWebserviceClassMap::classMap()
     * @uses NiksmsWebserviceWsdlClass::getDefaultWsdlOptions()
     * @uses NiksmsWebserviceWsdlClass::getSoapClientClassName()
     * @uses NiksmsWebserviceWsdlClass::setSoapClient()
     * @param array $_wsdlOptions WSDL options
     * @return void
     */
    public function initSoapClient($_wsdlOptions)
    {
        if(class_exists('NiksmsWebserviceClassMap',true))
        {
            $wsdlOptions = array();
            $wsdlOptions['classmap'] = NiksmsWebserviceClassMap::classMap();
     ...
     * If a class is named as {NiksmsWebservice}SoapClient, then this is the class that will be used.
    ...
    {
        if(class_exists('NiksmsWebserviceSoapClient') && is_subclass_of('NiksmsWebserviceSoapClient','SoapClient'))
            return 'NiksmsWebserviceSoapClient';
        else
            return 'SoapClient';
    }
    /**
     * Method returning all default options values
     * @uses NiksmsWebserviceWsdlClass::WSDL_CACHE_WSDL
     * @uses NiksmsWebserviceWsdlClass::WSDL_COMPRESSION
     * @uses NiksmsWebserviceWsdlClass::WSDL_CONNECTION_TIMEOUT
     * @uses NiksmsWebserviceWsdlClass::WSDL_ENCODING
     * @uses NiksmsWebserviceWsdlClass::WSDL_EXCEPTIONS
     * @uses NiksmsWebserviceWsdlClass::WSDL_FEATURES
     * @uses NiksmsWebserviceWsdlClass::WSDL_LOGIN
     * @uses NiksmsWebserviceWsdlClass::WSDL_PASSWORD
     * @uses NiksmsWebserviceWsdlClass::WSDL_SOAP_VERSION
     * @uses NiksmsWebserviceWsdlClass::WSDL_STREAM_CONTEXT
     * @uses NiksmsWebserviceWsdlClass::WSDL_TRACE
     * @uses NiksmsWebserviceWsdlClass::WSDL_TYPEMAP
     * @uses NiksmsWebserviceWsdlClass::WSDL_URL
     * @uses NiksmsWebserviceWsdlClass::VALUE_WSDL_URL
     * @uses NiksmsWebserviceWsdlClass::WSDL_USER_AGENT
     * @uses NiksmsWebserviceWsdlClass::WSDL_PROXY_HOST
     * @uses NiksmsWebserviceWsdlClass::WSDL_PROXY_PORT
     * @uses NiksmsWebserviceWsdlClass::WSDL_PROXY_LOGIN
     * @uses NiksmsWebserviceWsdlClass::WSDL_PROXY_PASSWORD
     * @uses NiksmsWebserviceWsdlClass::WSDL_LOCAL_CERT
     * @uses NiksmsWebserviceWsdlClass::WSDL_PASSPHRASE
     * @uses NiksmsWebserviceWsdlClass::WSDL_AUTHENTICATION
     * @uses NiksmsWebserviceWsdlClass::WSDL_SSL_METHOD
     ...
     * @uses NiksmsWebserviceWsdlClass::getSoapClient()
     * @uses NiksmsWebserviceWsdlClass::getFormatedXml()
     ...
     * @uses NiksmsWebserviceWsdlClass::getSoapClient()
     * @uses NiksmsWebserviceWsdlClass::convertStringHeadersToArray()
     ...
     * @uses NiksmsWebserviceWsdlClass::count()
     * @return int
     */
     ...
     * @uses NiksmsWebserviceWsdlClass::getInternArrayToIterate()
     * @uses NiksmsWebserviceWsdlClass::getInternArrayToIterateIsArray()
     * @return int
     */
     ...
     * @uses NiksmsWebserviceWsdlClass::offsetGet()
     * @return mixed
     */
     ...
     * @uses NiksmsWebserviceWsdlClass::getInternArrayToIterateOffset()
     * @uses NiksmsWebserviceWsdlClass::setInternArrayToIterateOffset()
     * @return int
     */
     ...
     * @uses NiksmsWebserviceWsdlClass::getInternArrayToIterateOffset()
     * @uses NiksmsWebserviceWsdlClass::offsetExists()
     * @return bool true|false
     */
     ...
     * @see NiksmsWebserviceWsdlClass::offsetGet()
     * @uses NiksmsWebserviceWsdlClass::offsetGet()
     * @param int $_index
     * @return mixed
     */
     ...
     * @uses NiksmsWebserviceWsdlClass::getAttributeName()
     * @uses NiksmsWebserviceWsdlClass::__toString()
     * @uses NiksmsWebserviceWsdlClass::_set()
     * @uses NiksmsWebserviceWsdlClass::_get()
     * @uses NiksmsWebserviceWsdlClass::setInternArrayToIterate()
     * @uses NiksmsWebserviceWsdlClass::setInternArrayToIterateIsArray()
     * @uses NiksmsWebserviceWsdlClass::setInternArrayToIterateOffset()
     ...
     * @uses NiksmsWebserviceWsdlClass::item()
     * @return mixed
     */
     ...
     * @uses NiksmsWebserviceWsdlClass::item()
     * @uses NiksmsWebserviceWsdlClass::length()
     * @return mixed
     */
