<?php
/**
 * File for class NiksmsWebserviceStructGetServertime
 ...
 */
/**
 * This class stands for NiksmsWebserviceStructGetServertime originally named GetServertime
 ...
 * @date 2016-01-03
 */
class NiksmsWebserviceStructGetServertime extends NiksmsWebserviceWsdlClass
{
    /**
     * The security
     * Meta informations extracted from the WSDL
    ...
    public $security;
    /**
     * Constructor method for GetServertime
     * @see parent::__construct()
     * @param NiksmsWebserviceStructAuthenticationModel $_security
     * @return NiksmsWebserviceStructGetServertime
     */
