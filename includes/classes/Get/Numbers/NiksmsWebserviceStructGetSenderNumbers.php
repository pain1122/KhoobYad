<?php
/**
 * File for class NiksmsWebserviceStructGetSenderNumbers
 ...
 */
/**
 * This class stands for NiksmsWebserviceStructGetSenderNumbers originally named GetSenderNumbers
 ...
 * @date 2016-01-03
 */
class NiksmsWebserviceStructGetSenderNumbers extends NiksmsWebserviceWsdlClass
{
    /**
     * The security
     * Meta informations extracted from the WSDL
    ...
    public $security;
    /**
     * Constructor method for GetSenderNumbers
     * @see parent::__construct()
     * @param NiksmsWebserviceStructAuthenticationModel $_security
     * @return NiksmsWebserviceStructGetSenderNumbers
     */
