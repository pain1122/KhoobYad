<?php
/**
 * File for class NiksmsWebserviceStructGetDiscountCredit
 ...
 */
/**
 * This class stands for NiksmsWebserviceStructGetDiscountCredit originally named GetDiscountCredit
 ...
 * @date 2016-01-03
 */
class NiksmsWebserviceStructGetDiscountCredit extends NiksmsWebserviceWsdlClass
{
    /**
     * The security
     * Meta informations extracted from the WSDL
    ...
    public $security;
    /**
     * Constructor method for GetDiscountCredit
     * @see parent::__construct()
     * @param NiksmsWebserviceStructAuthenticationModel $_security
     * @return NiksmsWebserviceStructGetDiscountCredit
     */
