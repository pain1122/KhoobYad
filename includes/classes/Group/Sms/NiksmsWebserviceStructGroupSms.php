<?php
/**
 * File for class NiksmsWebserviceStructGroupSms
 ...
 */
/**
 * This class stands for NiksmsWebserviceStructGroupSms originally named GroupSms
 ...
 * @date 2016-01-03
 */
class NiksmsWebserviceStructGroupSms extends NiksmsWebserviceWsdlClass
{
    /**
     * The security
     * Meta informations extracted from the WSDL
     ...
     * - maxOccurs : 1
     * - minOccurs : 0
     * @var NiksmsWebserviceStructGroupSmsModel
     */
    public $model;
    /**
     * Constructor method for GroupSms
     * @see parent::__construct()
     * @param NiksmsWebserviceStructAuthenticationModel $_security
     * @param NiksmsWebserviceStructGroupSmsModel $_model
     * @return NiksmsWebserviceStructGroupSms
     */
    ...
    /**
     * Get model value
     * @return NiksmsWebserviceStructGroupSmsModel|null
     */
    ...
    /**
     * Set model value
     * @param NiksmsWebserviceStructGroupSmsModel $_model the model
     * @return NiksmsWebserviceStructGroupSmsModel
     */
