...
foreach ($all_posts as $post) :
  if ($post['post_id'] > 0) :
    ...
    <div class="dropdown-menu">
      ...
      <a class="dropdown-item" href="index.php?page=sliders/add-slider.php&id=' . $post_id . '" target="_blank"><i class="bx bx-edit-alt me-1"></i> ویرایش</a>
      <a class="dropdown-item" href="index.php?page=sliders/all-sliders.php&delete=' . $post_id . '"><i class="bx bx-trash me-1"></i> حذف</a>
    </div>
  </div>';
