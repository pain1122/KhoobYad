    ...
    <?php if ($participated == true): ?>
        <div class="card-body">
            ...
            <a class="btn btn-info" id="participant-link"
                href="?page=exams/descriptive-result.php&exam=<?php echo $result['post_id']; ?>" target="_blank"><i
    ...
    $(window).ready(function () {
        ...
        if (dt_user_table.length) {
            var dt_user = dt_user_table.DataTable({
                ...
                select: true,
                ajax: {
                    url: 'API/v1/GetDescriptiveExamResults.php?ID=<?php echo $post_id; ?>'
                },
                columns: [
                    {
                        data: 'user_name'
                ...
                columnDefs: [
                {
                    ...
                    <?php if ($role != 'student') { ?>
                            ...
                            var $user_name = full['user_name'],
                                $id = full['post_id'];
                            var $row_output =
                                '<a href="index.php?page=descriptive-exams/descriptive-result.php&exam=' + $id + '">' +
