...
<div class="card">
    <div class="card-header">
        <h5>شرکت کنندگان آزمون <?php echo $title; ?></h5>
    </div>
    <?php if ($participated == true): ?>
        <div class="card-body">
            ...
            <a class="btn btn-info" id="participant-link"
                href="?page=test-books/result.php&exam=<?php echo $result['post_id']; ?>" target="_blank"><i
    ...
    $(window).ready(function () {
        ...
        if (dt_user_table.length) {
            var dt_user = dt_user_table.DataTable({
                ...
                select: true,
                ajax: {
                    url: 'API/v1/GetTestbooksResults.php?ID=<?php echo $post_id; ?>'
                },
                columns: [
