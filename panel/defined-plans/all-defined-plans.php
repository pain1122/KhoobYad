...
if (isset($_GET['delete'])) {
    ...
    if ($plan_id > 0) {
        $delete_q = "UPDATE `post` SET `post_type` = 'deleted_defined_plan' WHERE `post_id` = $plan_id";
    ...
    $(window).ready(function() {
        ...
        if (dt_user_table.length) {
            var dt_user = dt_user_table.DataTable({
                ...
                select: true,
                ajax: {
                    url: 'API/v1/GetDefinedStudyPlans.php'
                },
                columns: [
                ...
                columnDefs: [{
                    ...
                    },
                    {
                        ...
                        render: function(data, type, full, meta) {
                            var $name = full['title'],
                                $id = full['post_id'];
                            var $row_output =
                                '<a href="index.php?page=defined-plans/add-plan.php&id=' + $id + '">' +
                    ...
                    },
                    {
                        ...
                        render: function(data, type, full, meta) {
                            ...
                            return "<span class='text-truncate d-flex align-items-center'>" + $course + '</span>';
                        }
                    },
                    {
                        // grade
                    ...
                    },
                    {
                        ...
                        render: function(data, type, full, meta) {
                            ...
                            return '<span class="fw-semibold">' + $sessions + '</span>';
                        }
                    },
                    {
                        // op
